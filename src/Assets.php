...
class Assets
{
     ...
     *
     * @var array<string, string|array<string, string|array<string>>> $collections
     */
    ...
    /**
     * @param array<string|bool|int|Closure|null|array<string, string|array<string, string|array<string>>>> $options
     ...
     *
     * @param array<string|bool|int|Closure|null|array<string, string|array<string, string|array<string>>>> $config
     ...
     * @return Assets
     */
    public function add(mixed $asset): self
    {
        // More than one asset
        if (is_array($asset)) {
            foreach ($asset as $a) {
     ...
     * @return Assets
     */
    public function prepend(mixed $asset): self
    {
        // More than one asset
        if (is_array($asset)) {
     ...
     * @return Assets
     */
    public function addCss(mixed $asset): self
    {
        if (is_array($asset)) {
            foreach ($asset as $a) {
                $this->addCss($a);
     ...
     * @return Assets
     */
    public function prependCss(mixed $asset): self
    {
        if (is_array($asset)) {
            foreach (array_reverse($asset) as $a) {
                $this->prependCss($a);
     ...
     * @return Assets
     */
    public function addJs(mixed $asset): self
    {
        if (is_array($asset)) {
            foreach ($asset as $a) {
                $this->addJs($a);
     ...
     * @return Assets
     */
    public function prependJs(mixed $asset): self
    {
        if (is_array($asset)) {
            foreach (array_reverse($asset) as $a) {
                $this->prependJs($a);
     ...
     * @return Assets
     */
    public function registerCollection(string $collectionName, array $assets): self
    {
     ...
     * @return Assets
     */
    public function addDir(string $directory, ?string $pattern = null): self
    {
     ...
     * @return Assets
     */
    public function addDirCss(string $directory): self
    {
     ...
     * @return Assets
     */
    public function addDirJs(string $directory): self
    {
