...
class ObjectStorageMap implements ContainerInterface, ArrayAccess, Countable, IteratorAggregate
{
     ...
     * Add data to set.
     *
     * @param array<string, mixed> $items Key-value array of data to append to this set
     */
     ...
     * @param array<mixed> $values   An array of values that customizes the provider
     *
     * @return static
     */
