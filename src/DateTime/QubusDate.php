...
readonly class QubusDate implements Date
{
     ...
     *
     * @return Carbon|null Returns current localized datetime.
     */
    public function locale(): Carbon|null
    {
        $timestamp = $this->date;
    ...
    {
        $from = new QubusDateTimeImmutable()->setTimestamp(unixTimestamp: $original);
        $to   = new QubusDateTimeImmutable(time: 'now');
