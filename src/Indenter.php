...
final class Indenter
{
    ...
    /** @var array<string> $inlineElements */
    ...
    /** @var array<string> $ignoreElements */
    private array $ignoreElements = ['pre', 'script', 'textarea'];

    /** @var array<mixed> $temporaryReplacementsScript */
    private array $temporaryReplacementsScript = [];

    /** @var array<mixed> $temporaryReplacementsIgnore */
    private array $temporaryReplacementsIgnore = [];

    /** @var array<mixed> $temporaryReplacementsInline */
