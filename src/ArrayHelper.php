...
class ArrayHelper
{
     ...
     * not exist.
     *
     * @param array<mixed>|ArrayAccess $array $array The search array.
     ...
     *
     * @param array<mixed>   $array  The array to insert it into
     ...
     *
     * @param array<mixed> $array Collection of arrays to pluck from.
     ...
     * @return array<mixed> Array of plucked values.
     * @throws TypeException
     */
     ...
     *
     * @param array<mixed> $array The search array.
     * @param mixed|null   $key   The dot-notated key or array of keys.
     * @return array<mixed>|bool
     */
    public function delete(array &$array, mixed $key = null): array|bool
    {
        if ($key === null) {
            return false;
        }
     ...
     *
     * @param array<mixed>|Iterator $assoc The array to convert.
     ...
     *
     * @param array<mixed>|Iterator $array $array      the array to convert
     * @param string $keyField the field name of the key field
     * @param string $valField the field name of the value field
     * @return array<mixed>
     */
     ...
     *
     * @param array<mixed>  $arr  the array to change
     * @return array<mixed>|null  the new array or null
     ...
     *
     * @param array<mixed>   $array  flattened array
     * @param string         $glue   glue used in flattening
     * @return array<mixed> The unflattened array.
     */
     ...
     *
     * @param array<mixed>   $array        The array to filter.
     ...
     *
     * @param array<mixed>  $array  The array to remove from.
     * @param string        $prefix Prefix to filter on.
     * @return array<mixed>
     */
     ...
     *
     * @param array<mixed>  $array  The array to filter.
     * @param array<mixed>  $keys   The keys to filter
     ...
     *
     * @param array<mixed> $original The original array (by reference).
     ...
     *
     * @param array<mixed> $array     The array to fetch from.
     ...
     *
     * @param array<mixed> $array Collection of arrays/objects to sort.
     * @param array<mixed> $conditions Sorting conditions.
     ...
     *
     * @param array<mixed> $array The array containing the values.
     ...
     *
     * @param array<mixed> $source The array containing the key/value combinations
     * @param array<mixed>|string $replace Key to replace or array containing the replacement keys
     * @param string|null $newKey The replacement key
     * @return array<mixed> The array with the new keys.
     */
     ...
     *
     * @param array<mixed>        $arr   The array to prepend to
     * @param array<mixed>|string $key   The key or array of keys and values
     * @param array<mixed>|null $value The value to prepend
     */
     ...
     * @param array<mixed> $haystack Array to search in.
     ...
     *
     * @param array<mixed> $arr The array to dedupe.
     * @return array<mixed> array With only de-duped values.
     */
     ...
     *
     * @param array<mixed>|ArrayAccess $array $array The array containing the values.
     * @param string $key Key of the value to pluck.
     ...
     *
     * @param array<mixed> $arr The array to reindex.
     * @return array<mixed> Re-indexed array.
     */
     ...
     *
     * @param array<mixed> $array The array containing the values.
     * @param array<mixed> $keys List of keys (or indices) to return.
     * @param mixed|null $default Value of missing keys; default null.
     * @return array<mixed> An array containing the same set of keys provided.
     * @throws TypeException
     */
